...
! function(e, t) {
    ...
    var I, L, U, G, j, K, q, D, V, J, Y, Q, W, X, Z, r = (ScrollSmoother.register = function register(e) {
    ...
    function ScrollSmoother(t) {
        ...
        function Sa(r, e, t, n, o) {
            ...
            var i, s, a, l, c, f, u = Ra("speed", e, n, r),
                h = Ra("lag", t, n, r),
                d = I.getProperty(r, "y"),
                g = r._gsap,
                p = [],
        ...
        var n, S, e, i, b, s, a, l, c, f, r, u, h, d, g, p = t.smoothTouch,
            m = t.onUpdate,
            w = t.onStop,
            _ = t.smooth,
            T = t.onFocusIn,
